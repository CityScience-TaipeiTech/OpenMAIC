      ...
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 border-orange-200/60 dark:border-orange-700/50'
      ...
      <div className="flex items-center gap-2.5">
        <Icon
          className={cn(
            ...
            enabled ? 'text-orange-600 dark:text-orange-400' : 'text-muted-foreground/50',
          )}
        />
        <span
          className={cn(
