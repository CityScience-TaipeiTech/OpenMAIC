                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-orange-600 hover:bg-orange-700 shadow-[0_4px_16px_rgba(147,51,234,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-orange-400 to-amber-500" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-orange-600 dark:text-orange-300 uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-orange-600 to-orange-700 shadow-[0_4px_20px_rgba(249,115,22,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-orange-500 opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
                    ...
                    {((activeRole === 'agent' && speakingStudent) ||
                      ...
                      >
                        <div className="relative w-10 h-10 rounded-full flex items-center justify-center">
                          <div className="absolute inset-0 rounded-full border-2 border-orange-500 shadow-[0_0_6px_rgba(249,115,22,0.3)] transition-all duration-300" />
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-orange-400"
                          />
                        ))}
                      </div>
                    </div>
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-orange-500 shadow-[0_0_6px_rgba(168,85,247,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-orange-400/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        >
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-orange-50/50 dark:from-orange-900/10 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-orange-900 dark:text-orange-100" />
            <div className="w-8 h-0.5 bg-orange-900 dark:bg-orange-100 rounded-full" />
          </div>
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-orange-500 dark:border-orange-400 shadow-[0_0_12px_rgba(168,85,247,0.4)]'
                            : 'border-gray-200 dark:border-gray-700 group-hover:border-orange-300 dark:group-hover:border-orange-600',
                        )}
                      />
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ...
                          : 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-orange-500 dark:group-hover:text-orange-400 group-hover:border-orange-200 dark:group-hover:border-orange-600',
                      )}
                    >
                      {teacherName}
                    </span>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <span
                              ...
                              style={{
                                backgroundColor: teacherConfig?.color || '#f97316',
                              }}
                            >
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-orange-200 dark:border-orange-700 flex items-end gap-2 ring-1 ring-orange-100/50 dark:ring-orange-800/50">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 shadow-orange-200 dark:shadow-orange-900/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-orange-100 dark:border-orange-800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-orange-500 to-amber-500 dark:from-orange-400 dark:to-amber-400" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-orange-600 dark:text-orange-400 uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-orange-100/50 dark:border-orange-800/50 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-orange-600 to-orange-700 dark:from-orange-500 dark:to-orange-600 shadow-[0_4px_20px_rgba(249,115,22,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-orange-500 dark:border-orange-400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    <div className="absolute inset-0 rounded-full border border-amber-400 dark:border-amber-300 opacity-20 animate-[ping_3s_ease-in-out_infinite_0.5s] z-10" />
                    <div className="absolute inset-0 bg-orange-600 dark:bg-orange-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-orange-400/[0.08] dark:bg-orange-500/[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-orange-400/50 dark:border-orange-500/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-orange-300/40 dark:border-orange-400/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-orange-400 to-orange-500 dark:from-orange-500 dark:to-orange-600 shadow-orange-400/30 dark:shadow-orange-600/20 hover:shadow-orange-400/40 dark:hover:shadow-orange-600/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-orange-400/60 dark:bg-orange-500/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-orange-600/95 dark:bg-orange-500/95 backdrop-blur-sm border-orange-400/40 dark:border-orange-300/40 text-white rounded-br-sm shadow-md shadow-orange-300/30 dark:shadow-orange-800/30'
                          : bubbleRole === 'agent'
                            ? cn(
                                'bg-orange-50/95 dark:bg-orange-950/60 backdrop-blur-sm border-orange-200/60 dark:border-orange-800/60 text-gray-700 dark:text-gray-200 rounded-br-sm shadow-sm',
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-orange-400' : 'bg-orange-500';

                          if (btnState === 'none') return null;

                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-orange-100 dark:hover:bg-orange-900/50 group-hover/bubble:bg-orange-100 dark:group-hover/bubble:bg-orange-900/50 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-orange-600 dark:hover:text-orange-400 group-hover/bubble:text-orange-600 dark:group-hover/bubble:text-orange-400 ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-orange-100 dark:hover:bg-orange-900/50 group-hover/bubble:bg-orange-100 dark:group-hover/bubble:bg-orange-900/50 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-orange-600 dark:hover:text-orange-400 group-hover/bubble:text-orange-600 dark:group-hover/bubble:text-orange-400" />
                              </div>
                            );
                          }
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-orange-100 dark:group-hover/bubble:bg-orange-900/50 transition-all duration-300">
                              {isDiscussionPaused ? (
                          ...
                          >
                            <div
                              className={cn(
                                'absolute inset-0 rounded-full border-2 transition-all duration-300',
                                isSpeaking
                                  ? 'border-orange-500 dark:border-orange-400 shadow-[0_0_8px_rgba(168,85,247,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-orange-400 border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-orange-400 dark:bg-orange-400"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-orange-600 dark:bg-orange-500 border-orange-600 dark:border-orange-500 text-white shadow-orange-200 dark:shadow-orange-800'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 hover:text-orange-600 dark:hover:text-orange-400 hover:border-orange-200 dark:hover:border-orange-700',
                    )}
                  >
                    {asrEnabled ? (
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-orange-600 dark:border-orange-400 shadow-[0_0_8px_rgba(168,85,247,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-orange-200 dark:group-hover:border-orange-600',
                  )}
                />
