...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-card/80">
  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-card/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-orange-300/50 dark:ring-orange-600/40 group-hover/avatar:ring-orange-400 dark:group-hover/avatar:ring-orange-500 transition-all">
            <img src={avatar} alt="" className="size-full object-cover" />
          </div>
          <div className="absolute -bottom-0.5 -right-0.5 size-4 rounded-full bg-white dark:bg-secondary border border-muted/60 flex items-center justify-center">
            <ChevronDown
              className={cn(
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-orange-400 dark:border-orange-500 text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-orange-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-orange-400 dark:ring-orange-500 ring-offset-1 ring-offset-white dark:ring-offset-background'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-orange-400 dark:ring-orange-500 ring-offset-1 ring-offset-white dark:ring-offset-background border-orange-300 dark:border-orange-600 bg-orange-50 dark:bg-orange-900/30'
