      ...
      >
        ...
        {!collapsed && (
          <div
            ...
            className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-orange-400/30 dark:hover:bg-orange-600/30 active:bg-orange-500/40 dark:active:bg-orange-500/40 transition-colors"
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-gray-300 dark:bg-gray-600 group-hover:bg-orange-400 dark:group-hover:bg-orange-500 transition-colors" />
          </div>
        )}
