...
const WB_STYLE =
  'bg-orange-50 dark:bg-orange-500/15 border-orange-300/40 dark:border-orange-500/30 text-orange-600 dark:text-orange-300';
const WB_ACCENT = 'bg-orange-500 dark:bg-orange-400';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-orange-950" strokeWidth={2.5} />
        </span>
      )}
