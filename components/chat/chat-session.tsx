      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-orange-400/70 dark:bg-orange-500/70'
              : 'bg-orange-400/70 dark:bg-orange-500/70',
          )}
        />
        <span
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-orange-600 to-orange-700 dark:from-orange-500 dark:to-orange-600 text-white rounded-tr-sm shadow-sm shadow-orange-300/30 dark:shadow-orange-900/50 ring-1 ring-orange-500/20'
          : isTeacher
            ...
            : 'bg-orange-50 dark:bg-orange-900/20 text-orange-900 dark:text-orange-200 border border-orange-100/50 dark:border-orange-800/50 rounded-tl-sm',
      )}
    >
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-orange-500 dark:border-l-orange-400 bg-orange-50/50 dark:bg-orange-900/20',
              )}
            >
              {/* Mini Avatar */}
