  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
        <PieChart className="w-52 h-52 text-orange-500" />
      </div>
      <div className="absolute bottom-0 left-0 p-6 opacity-[0.02]">
        <BookOpenText className="w-40 h-40 text-orange-500 rotate-12" />
      </div>
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-orange-100 to-orange-50 dark:from-orange-900/50 dark:to-orange-900/30 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-100 dark:shadow-orange-900/30 ring-1 ring-orange-200/50 dark:ring-orange-700/50"
      >
      ...
      >
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center">
            <BookOpenText className="w-3.5 h-3.5 text-orange-500" />
          </div>
          <span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-orange-500 to-orange-500 text-white rounded-full font-medium shadow-lg shadow-orange-200/50 dark:shadow-orange-900/50 hover:shadow-orange-300/50 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-orange-200 dark:hover:border-orange-700 hover:bg-orange-50/50 dark:hover:bg-orange-900/30',
                !isReview &&
                  selected &&
                  'border-orange-400 bg-orange-50 dark:bg-orange-900/30 ring-1 ring-orange-200 dark:ring-orange-700',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-orange-500 text-white',
              ...
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
                  !isReview && isSelected && 'bg-orange-500 text-white',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-gray-200 dark:border-gray-600 text-sm resize-none focus:outline-none focus:border-orange-300 dark:focus:border-orange-600 focus:ring-2 focus:ring-orange-100 dark:focus:ring-orange-900/50 transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:bg-gray-800/50 dark:text-gray-200 dark:placeholder:text-gray-500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-orange-50 dark:bg-orange-900/30 border border-orange-100 dark:border-orange-800">
              ...
              <span className="ml-auto text-xs font-bold text-orange-600 dark:text-orange-400 shrink-0">
  ...
  return (
    ...
    >
      ...
      {isReview && question.analysis && (
        <div className="mt-3 p-3 rounded-lg bg-orange-50/70 dark:bg-orange-900/30 border border-orange-100 dark:border-orange-800 text-xs text-orange-700 dark:text-orange-300 leading-relaxed">
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-orange-500 to-orange-500 text-white shadow-sm hover:shadow-md hover:shadow-orange-200/50 dark:hover:shadow-orange-900/50 active:scale-[0.97]'
        ...
        {phase === 'reviewing' && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                onClick={handleRetry}
                className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors"
              >
