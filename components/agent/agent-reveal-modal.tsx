                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0 rounded-2xl p-[2px]"
                        style={{
                          background: 'linear-gradient(160deg, #f97316, #fb923c, #f97316)',
                        }}
                      >
                        <div
                        ...
                        >
                          ...
                          {/* Center icon */}
                          <Sparkles className="size-9 text-orange-300/70" />
                          <span className="mt-1.5 text-xl font-bold text-orange-200/60">?</span>
                        </div>
                      </div>
                    </div>
                  </motion.div>
