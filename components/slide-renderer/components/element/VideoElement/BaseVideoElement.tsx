    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-orange-50 via-amber-50/60 to-yellow-50 dark:from-orange-950/40 dark:via-amber-950/30 dark:to-yellow-950/20 flex items-center justify-center rounded">
            <style>{`
              @keyframes vid-pulse-ring { 0%, 100% { opacity: 0.15; transform: scale(0.85); } 50% { opacity: 0.35; transform: scale(1.1); } }
            `}</style>
            <div className="relative w-14 h-14">
              <div
                className="absolute inset-0 rounded-full border-2 border-orange-300/40 dark:border-orange-500/30"
                style={{
                  animation: 'vid-pulse-ring 2.4s ease-in-out infinite',
                }}
              />
              <Film
                className="absolute inset-0 m-auto w-5 h-5 text-orange-400/80 dark:text-orange-500/70"
                strokeWidth={1.5}
              />
            </div>
          </div>
