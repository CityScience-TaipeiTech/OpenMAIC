...
export const stageZhTW = {
  stage: {
    ...
    confirmSwitchMessage: '當前話題正在進行中，切換頁面將結束當前話題。確定要切換嗎？',
  ...
  roundtable: {
    ...
    listening: '錄音中...',
    processing: '處理中...',
    noSpeechDetected: '未檢測到語音，請重試',
    discussionEnded: '討論已結束',
    qaEnded: '問答已結束',
    thinking: '思考中',
    yourTurn: '輪到你發言了',
    stopDiscussion: '結束討論',
    pauseDiscussion: '暫停閱讀',
    resumeDiscussion: '繼續閱讀',
    autoPlay: '自動播放',
    autoPlayOff: '關閉自動播放',
    speed: '倍速',
  },
