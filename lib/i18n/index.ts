...
import { commonZhCN, commonEnUS, commonZhTW } from './common';
import { stageZhCN, stageEnUS, stageZhTW } from './stage';
import { chatZhCN, chatEnUS, chatZhTW } from './chat';
import { generationZhCN, generationEnUS, generationZhTW } from './generation';
import { settingsZhCN, settingsEnUS, settingsZhTW } from './settings';
