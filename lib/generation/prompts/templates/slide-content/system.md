...
- **When dimensions are provided** (e.g., "**img_1**: 尺寸: 884×424 (寬高比2.08)"):
  - Choose a width based on layout needs (typically 300-500px)
  - Calculate: `height = width / 寬高比`
  - Example: 寬高比 2.08, width 400 → height = 400 / 2.08 ≈ 192
